...
class Task2_Warehouse {
    private int warehouseNumber;
    private int availableSpace;
    private Task2_Person owner;

    public Task2_Warehouse(int warehouseNumber, int availableSpace, Task2_Person owner) {
    ...
    public Task2_Person getOwner() {
        return owner;
    }

    public void setOwner(Task2_Person owner) {
        this.owner = owner;
    }
