package pl.pp;
import pl.pp.Task1_Person;

public class Task1_Main {
    public static void main(String[] args) {
        Task1_Person person1 = new Task1_Person(); // create object person1 of class Person with default parameters/attributes
        ...
        Task1_Person person2 = new Task1_Person("Alice", "Hart", 42);
        person2.hiToAll();
